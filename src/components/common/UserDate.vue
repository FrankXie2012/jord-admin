...
<el-form label-width="80px">
    <el-form-item label="文章作者" prop="author">
        <el-select v-model="author" filterable placeholder="请选择" class="item-width" @change="changeAuthor">
            <el-option v-for="user in users" :key="user.id" :label="user.name" :value="user.name">
            </el-option>
        </el-select>
    </el-form-item>
    <el-form-item label="发布日期" prop="publishDate">
        <el-date-picker v-model="publishDate" type="date" class="item-width" :editable="false" placeholder="选择日期" value-format="yyyy-MM-dd" @change="changeDate">
        </el-date-picker>
    </el-form-item>
</el-form>
</template>
